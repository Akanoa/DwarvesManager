...
public class InfoBar extends Table{
	...
	public void act(float delta) {
		...
		time.setText("Temps : " + scene.getGame().getLevel().getDwScript().getFormattedElapsedTime());
		nextSalaries.setText("Versement des salaires (" +
							Integer.toString(scene.getGame().getCharacters().getPayroll()) + ") dans : " +
							scene.getGame().getLevel().getDwScript().getFormattedWageTimer());
		this.pack();
	}

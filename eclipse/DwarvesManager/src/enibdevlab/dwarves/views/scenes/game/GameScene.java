...
public class GameScene extends Stage{
	 ...
	 */
	public GameScene(DwarvesManager gdxGame, Class<? extends DWLevel> level){
		PAUSED = false;
		this.gdxGame = gdxGame;
		this.setGame(new Game(this, level));
		this.setGameplayLayer(new GameplayLayer(this.getGame().getLevel()));
		this.addActor(this.getGameplayLayer());
		this.init();
		this.gameState = GameState.NORMAL;
		MusicManager.playMusic("data/music/" + this.getGame().getLevel().getDwScript().getMusicName());
	}
	...
	public void init(){
		...
		//this.addActor(new ADiamondEffect());
	}

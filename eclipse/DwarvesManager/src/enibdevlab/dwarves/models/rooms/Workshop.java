...
public class Workshop extends Room {
	...
	public Workshop(MapArea mapArea) {
		this(mapArea.getI(), mapArea.getJ(), mapArea.getW(), mapArea.getH(), mapArea.getTilemap(), mapArea.getTilemap().getLevel().getGame().getRooms());
	}

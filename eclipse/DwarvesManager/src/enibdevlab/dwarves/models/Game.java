...
public final class Game implements IPersistent{
	 ...
	 * Constructeur
	 */
	public Game(GameScene view, Class<? extends DWLevel> script){
	...
	/**
	 * Charge une partie à partir d'un fichier xml sauvegardée sur la machine
	 */
	...
	public Element saveAsXmlElement() {
		...
		FileHandle file = Gdx.files.external("DwarvesManager/Saves/"+this.filename+".xml");
